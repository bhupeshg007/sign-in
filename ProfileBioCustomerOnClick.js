...
export default function ProfileBioCustomerOnClick({ navigation }) {
  return (
        ...
        <View style={styles.profileImgView}>
          <TouchableOpacity style={styles.touchProfileImg1}>
            <Image
              ...
              source={require("./assets/ProfileBioCustomerOnClick2.png")}
            />
            <Text style={styles.profileText1}>Prestataire</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.touchProfileImg2}
            onPress={() => {
              navigation.navigate("ProfileBioCustomerProfilePopUp");
            }}
          >
            <Image
              style={styles.profileImg2}
              source={require("./assets/ProfileBioCustomerOnClick1.png")}
            />
